...
//                System.out.println(p.getName()+" > Finding column...");
    ...
    public static Match buildGame(int seats, int nRounds) throws RemoteException {
        ...
        PlayerController pC1 = new PlayerController("Kratos", new ClientInputHandler(), null);
        Player p1 = pC1.getPlayer();
        PlayerController pC2 = new PlayerController("Omar", new ClientInputHandler(), null);
        Player p2 = pC2.getPlayer();
        PlayerController pC3 = new PlayerController("Silvestro", new ClientInputHandler(), null);
        Player p3 = pC3.getPlayer();
        PlayerController pC4 = new PlayerController("Jane", new ClientInputHandler(), null);
